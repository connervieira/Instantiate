...
<html>
    ...
    <body>
        ...
        if (time() - intval($_GET["confirm"]) < 0) { // Check to see if the confirmation timestamp is in the future.
            echo "<p class=\"warning\">Warning: The confirmation timestamp is in the future. This should never happen. If you clicked an external link to get here, it's possible someone is trying to manipulate you into following all profiles.</p>";
            ...
            foreach ($profiles as $profile) { // Iterate through each file in the Instagram archive.
                ...
                if (is_dir($profile_file_path)) { // Only continue if this file-path is a directory.
                    $instantiate_database[$username]["following"][$profile] = array(); // Add this profile to this user's follow list.
                }
            }
